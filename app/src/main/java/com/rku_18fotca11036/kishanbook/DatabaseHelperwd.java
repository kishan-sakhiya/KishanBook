...
public class DatabaseHelperwd extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "wd";
    public static final String TABLE_NAME = "wd_table";
    public static final String COL_1 = "ID";
    public static final String COL_2 = "date";
    public static final String COL_3 = "money";

    public DatabaseHelperwd(@Nullable Context context) {
